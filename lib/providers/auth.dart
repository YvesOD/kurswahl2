...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyCnlVSA8iPqZ1jdjIpJDDx6prleVg9I9Y8';
    try {
//      print('Try Auth: $url');
...
//      print('temp: $temp');
      ...
      _autoLogout();
      if (isAuth) {
        // email is used for authorization to identify corresponding school etc.
        _email = email;
      }
      notifyListeners();
